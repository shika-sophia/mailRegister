...
public class EnCodeURL {
  ...
  public StringBuilder buildMessageCode() {
      ...
      return messageCode;
  }//buildMessageCode or main()


//====== buildNameCode() ======
  private StringBuilder buildNameCode(List<Integer> nameUni) {
  ...
  //====== buildPassCode() ======
  public StringBuilder buildPassCode(String pass) {
  ...
  //====== buildMailCode() ======
  private StringBuilder buildMailCode(List<Integer> mailUni) {
